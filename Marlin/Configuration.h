...
#undef KNUTWURST_MEGA
#undef KNUTWURST_MEGA_X 
#undef KNUTWURST_MEGA_P 
#undef KNUTWURST_DGUS2_TFT 
#undef KNUTWURST_TMC 
#undef KNUTWURST_BLTOUCH
#undef KNUTWURST_ONE_Z_ENDSTOP 
#undef KNUTWURST_CHIRON
/**
 * Configuration.h
 *
...
#define STRING_CONFIG_H_AUTHOR "(Valentine Shilov)"
...
*/
	//ValentineS
	  #define DEFAULT_Kp 15.27
	  #define DEFAULT_Ki 1.29
	  #define DEFAULT_Kd 45.34
#endif // PIDTEMP
...
//ValentineS
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 387 } //measured 406  ->400
...
#define VALENTINES_Y_PRINTER_OFFSET 4
#define X_MIN_POS 0
#define Y_MIN_POS -VALENTINES_Y_PRINTER_OFFSET
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 205 //ValentineS
...
//#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 500  //ValentineS
